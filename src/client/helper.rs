...
pub struct QualityStatus {
    ...
    pub transport_mtu: Option<u16>,
    pub transport_rtt_ms: Option<u64>,
    pub transport_lost_packets: Option<u64>,
    pub datagram_payload: Option<usize>,
    pub negotiated_datagram_payload: Option<usize>,
    pub quic_protocol: Option<String>,
    pub quic_video_transport: Option<String>,
    pub quic_reassembly_drops: Option<u64>,
    pub quic_reassembly_reasons: Option<String>,
