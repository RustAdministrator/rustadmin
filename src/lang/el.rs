...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Εμφάνιση επικάλυψης"),
        ("Toolbar", "Γραμμή εργαλείων"),
        ("Opacity under cursor", "Αδιαφάνεια κάτω από τον δρομέα"),
        ("Quality monitor", "Οθόνη ποιότητας"),
        ("Inactive opacity", "Αδιαφάνεια αδράνειας"),
        ("Fade delay", "Καθυστέρηση ξεθωριάσματος"),
        ("Fade duration", "Διάρκεια ξεθωριάσματος"),
        ("Quality monitor appearance", "Εμφάνιση οθόνης ποιότητας"),
        ("Toolbar inactive opacity", "Αδιαφάνεια γραμμής εργαλείων σε αδράνεια"),
        ("Toolbar fade delay", "Καθυστέρηση ξεθωριάσματος γραμμής εργαλείων"),
        ("Toolbar fade duration", "Διάρκεια ξεθωριάσματος γραμμής εργαλείων"),
        ("Default Screen Scrolling", "Προεπιλεγμένη κύλιση οθόνης"),
        ("Cursor inertia time", "Χρόνος αδράνειας δρομέα"),

        ("Physical key input (VM compatibility)", "Φυσική εισαγωγή πλήκτρων (συμβατότητα VM)"),
        ("Settings layout", "Διάταξη ρυθμίσεων"),
        ("Modern", "Μοντέρνο"),
        ("Classic", "Κλασικό"),
