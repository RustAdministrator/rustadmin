...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Overlay-udseende"),
        ("Toolbar", "Værktøjslinje"),
        ("Opacity under cursor", "Uigennemsigtighed under markør"),
        ("Quality monitor", "Kvalitetsmonitor"),
        ("Inactive opacity", "Inaktiv uigennemsigtighed"),
        ("Fade delay", "Forsinkelse af udtoning"),
        ("Fade duration", "Varighed af udtoning"),
        ("Quality monitor appearance", "Udseende for kvalitetsmonitor"),
        ("Toolbar inactive opacity", "Inaktiv uigennemsigtighed for værktøjslinje"),
        ("Toolbar fade delay", "Forsinkelse af udtoning for værktøjslinje"),
        ("Toolbar fade duration", "Varighed af udtoning for værktøjslinje"),
        ("Default Screen Scrolling", "Standard skærmrulning"),
        ("Cursor inertia time", "Markørens inertitid"),

        ("Physical key input (VM compatibility)", "Fysisk tasteinput (VM-kompatibilitet)"),
        ("Settings layout", "Indstillingslayout"),
        ("Modern", "Moderne"),
        ("Classic", "Klassisk"),
