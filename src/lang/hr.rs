...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Quality monitor", "Monitor kvalitete"),
        ("Inactive opacity", "Neaktivna neprozirnost"),
        ("Fade delay", "Odgoda slabljenja"),
        ("Fade duration", "Trajanje slabljenja"),
        ("Quality monitor appearance", "Izgled monitora kvalitete"),
        ("Toolbar inactive opacity", "Neaktivna neprozirnost alatne trake"),
        ("Toolbar fade delay", "Odgoda slabljenja alatne trake"),
        ("Toolbar fade duration", "Trajanje slabljenja alatne trake"),
        ("Default Screen Scrolling", "Zadano pomicanje zaslona"),
        ("Cursor inertia time", "Vrijeme inercije kursora"),

        ("Physical key input (VM compatibility)", "Unos fizičke tipke (VM kompatibilnost)"),
        ("Settings layout", "Izgled postavki"),
        ("Modern", "Moderan"),
        ("Classic", "Klasičan"),
