...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "გადაფარვის იერსახე"),
        ("Toolbar", "ინსტრუმენტთა პანელი"),
        ("Opacity under cursor", "გამჭვირვალობა კურსორის ქვეშ"),
        ("Quality monitor", "ხარისხის მონიტორი"),
        ("Inactive opacity", "არააქტიური გამჭვირვალობა"),
        ("Fade delay", "გაქრობის დაყოვნება"),
        ("Fade duration", "გაქრობის ხანგრძლივობა"),
        ("Quality monitor appearance", "ხარისხის მონიტორის იერსახე"),
        ("Toolbar inactive opacity", "ინსტრუმენტთა პანელის არააქტიური გამჭვირვალობა"),
        ("Toolbar fade delay", "ინსტრუმენტთა პანელის გაქრობის დაყოვნება"),
        ("Toolbar fade duration", "ინსტრუმენტთა პანელის გაქრობის ხანგრძლივობა"),
        ("Default Screen Scrolling", "ეკრანის ნაგულისხმევი გადახვევა"),
        ("Cursor inertia time", "კურსორის ინერციის დრო"),

        ("Physical key input (VM compatibility)", "ფიზიკური კლავიატურის შეყვანა (VM თავსებადობა)"),
        ("Settings layout", "პარამეტრების განლაგება"),
        ("Modern", "თანამედროვე"),
        ("Classic", "კლასიკური"),
