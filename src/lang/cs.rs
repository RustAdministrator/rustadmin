...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Vzhled překrytí"),
        ("Toolbar", "Panel nástrojů"),
        ("Opacity under cursor", "Neprůhlednost pod kurzorem"),
        ("Quality monitor", "Monitor kvality"),
        ("Inactive opacity", "Neprůhlednost při nečinnosti"),
        ("Fade delay", "Zpoždění zmizení"),
        ("Fade duration", "Doba zmizení"),
        ("Quality monitor appearance", "Vzhled monitoru kvality"),
        ("Toolbar inactive opacity", "Neprůhlednost panelu nástrojů při nečinnosti"),
        ("Toolbar fade delay", "Zpoždění zmizení panelu nástrojů"),
        ("Toolbar fade duration", "Doba zmizení panelu nástrojů"),
        ("Default Screen Scrolling", "Výchozí posouvání obrazovky"),
        ("Cursor inertia time", "Doba setrvačnosti kurzoru"),

        ("Physical key input (VM compatibility)", "Fyzický vstup kláves (kompatibilita s VM)"),
        ("Settings layout", "Rozvržení nastavení"),
        ("Modern", "Moderní"),
        ("Classic", "Klasický"),
