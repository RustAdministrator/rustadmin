...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Ülekatte välimus"),
        ("Toolbar", "Tööriistariba"),
        ("Opacity under cursor", "Läbipaistmatus kursori all"),
        ("Quality monitor", "Kvaliteedimonitor"),
        ("Inactive opacity", "Läbipaistmatus puhkeolekus"),
        ("Fade delay", "Hääbumisviivitus"),
        ("Fade duration", "Hääbumiskestus"),
        ("Quality monitor appearance", "Kvaliteedimonitori välimus"),
        ("Toolbar inactive opacity", "Tööriistariba läbipaistmatus puhkeolekus"),
        ("Toolbar fade delay", "Tööriistariba hääbumisviivitus"),
        ("Toolbar fade duration", "Tööriistariba hääbumiskestus"),
        ("Default Screen Scrolling", "Ekraani vaikimisi kerimine"),
        ("Cursor inertia time", "Kursori inertsiaeg"),

        ("Physical key input (VM compatibility)", "Füüsiline klahvisisend (VM-i ühilduvus)"),
        ("Settings layout", "Seadete paigutus"),
        ("Modern", "Kaasaegne"),
