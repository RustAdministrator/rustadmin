...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "ઓવરલે દેખાવ"),
        ("Toolbar", "ટૂલબાર"),
        ("Opacity under cursor", "કર્સર હેઠળ અસ્પષ્ટતા"),
        ("Quality monitor", "ગુણવત્તા મોનિટર"),
        ("Inactive opacity", "નિષ્ક્રિય અસ્પષ્ટતા"),
        ("Fade delay", "ફેડ વિલંબ"),
        ("Fade duration", "ફેડ સમયગાળો"),
        ("Quality monitor appearance", "ગુણવત્તા મોનિટર દેખાવ"),
        ("Toolbar inactive opacity", "ટૂલબાર નિષ્ક્રિય અસ્પષ્ટતા"),
        ("Toolbar fade delay", "ટૂલબાર ફેડ વિલંબ"),
        ("Toolbar fade duration", "ટૂલબાર ફેડ સમયગાળો"),
        ("Default Screen Scrolling", "ડિફૉલ્ટ સ્ક્રીન સ્ક્રોલિંગ"),
        ("Cursor inertia time", "કર્સર જડતા સમય"),

        ("Physical key input (VM compatibility)", "ભૌતિક કી ઇનપુટ (VM સુસંગતતા)"),
        ("Settings layout", "સેટિંગ્સ લેઆઉટ"),
        ("Modern", "આધુનિક"),
        ("Classic", "ક્લાસિક"),
        ("Diagnostics", "નિદાન"),
    ].iter().cloned().collect();
