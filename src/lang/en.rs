...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("portable_elevated_tip", "Portable elevation is active for this session."),
        ...
        ("remote_restarting_tip", "Remote device is restarting, please close this message box and reconnect with the unattended access password after a while"),
        ...
        ("Receive clipboard from peer only", "Receive clipboard from peer only"),
        ("Disabled", "Disabled"),
        ...
        ("Physical key input (VM compatibility)", "Physical key input (VM compatibility)"),
        ...
        ("Use permanent password", "Use unattended access password"),
        ("Set permanent password", "Set unattended access password"),
        ("Clear permanent password", "Clear unattended access password"),
        ("hide_cm_tip", "Allow hiding only for unattended access password sessions"),
        ...
        ("codec_direction_tip", "Encoder is this device's hosting default; Decoder is its viewing default. HW and SW select the preferred local implementation independently at each end. Prefer hardware codec controls Auto backend choices, not explicit HW/SW choices. If a viewer requests a different format from the host default, the host uses its Auto backend preference for that format. Auto on both sides prefers AV1; conflicting explicit formats favor the viewer. Either implementation can fall back to the other when unavailable. Software H264/H265 choices appear only when included and validated in this build. Decoder HQ uses the same decoder and additionally requests high-quality encoding from the host. Defaults apply to new connections; the toolbar changes the current connection."),
        ("decoder_preference_tip", "Selects decoding on this device. H264/H265 prefer hardware; SW prefers software. HQ uses the same decoder and requests the host's high-quality encoding profile, independently of local HW/SW decoding. The host must advertise HQ support. Unavailable HQ falls back to the same normal format; runtime backend fallback is shown in Quality monitor."),
        ...
        ("Quality monitor position", "Quality monitor position"),
        ("Quality monitor details", "Quality monitor details"),
        ("Top right", "Top right"),
        ("Top left", "Top left"),
        ...
        ("Transport", "Transport"),
        ("Auto (QUIC preferred)", "Auto (QUIC preferred)"),
        ("QUIC only", "QUIC only"),
        ("TCP only", "TCP only"),
        ("VPN", "VPN"),
        ("Start WireGuard when unavailable", "Start WireGuard when unavailable"),
        ("WireGuard tunnel name", "WireGuard tunnel name"),
        ("WireGuard tunnel name is required", "WireGuard tunnel name is required"),
        ("Checking peer availability and VPN", "Checking peer availability and VPN"),
        ("Another VPN connection check is already running", "Another VPN connection check is already running"),
        ("WireGuard tunnel name is not configured", "WireGuard tunnel name is not configured"),
        ("WireGuard is not installed", "WireGuard is not installed"),
        ("WireGuard control permission was not granted", "WireGuard control permission was not granted"),
        ("Failed to request WireGuard tunnel start", "Failed to request WireGuard tunnel start"),
        ("WireGuard did not make the peer reachable. Check the tunnel name and Allow remote control apps in WireGuard", "WireGuard did not make the peer reachable. Check the tunnel name and Allow remote control apps in WireGuard"),
        ("WireGuard tunnel did not become active. Check the tunnel name and Allow remote control apps in WireGuard", "WireGuard tunnel did not become active. Check the tunnel name and Allow remote control apps in WireGuard"),
        ("WireGuard is active but did not make the peer reachable. Check the peer address and tunnel routes", "WireGuard is active but did not make the peer reachable. Check the peer address and tunnel routes"),
        ("VPN connection preparation failed", "VPN connection preparation failed"),
        ("Reconnecting...", "Reconnecting..."),
        ("Failed to reconnect", "Failed to reconnect"),
        ("enable-quic-tip", "Choose the remote-session transport. Auto prefers QUIC over any routed UDP path and falls back to TCP only when UDP is unavailable or the peer is too old. Certificate and peer identity failures never fall back."),
        ...
        ("password-hidden-tip", "Unattended access password is set (hidden)."),
        ...
        ("Toolbar", "Toolbar"),
        ("Opacity under cursor", "Opacity under cursor"),
        ("Inactive opacity", "Inactive opacity"),
        ("Fade delay", "Fade delay"),
        ("Fade duration", "Fade duration"),
        ("Quality monitor appearance", "Quality monitor appearance"),
        ("Toolbar inactive opacity", "Toolbar inactive opacity"),
        ("Toolbar fade delay", "Toolbar fade delay"),
        ("Toolbar fade duration", "Toolbar fade duration"),
        ("Default Screen Scrolling", "Default Screen Scrolling"),
        ("Cursor inertia time", "Cursor inertia time"),
