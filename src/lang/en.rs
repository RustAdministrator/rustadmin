...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("codec_direction_tip", "Encoder is this device's hosting default; Decoder is its viewing default. Auto on both sides prefers AV1; conflicting explicit selections favor the viewer. H264/H265 use hardware decoding; SW prefers software when included in this build. HQ uses the same decoder and additionally requests high-quality encoding from the host. Prefer hardware codec controls Auto decoding and host encoding; either implementation can fall back to the other when unavailable. Defaults apply to new connections; the toolbar changes the current connection."),
