...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("codec_direction_tip", "Encoder is this device's hosting default; Decoder is its viewing default. A viewer's explicit format request takes priority. The hardware preference controls host encoding and Auto decoder selection. Software encoders must be included in this build. Defaults apply to new connections; the toolbar changes the current connection."),
        ("decoder_preference_tip", "Selects decoding on this device. Only the video format is requested from the remote computer; it chooses its own encoder. HW prefers a validated hardware decoder; SW uses software. Runtime fallback is shown in Quality monitor."),
