...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "ظاهر پوشش"),
        ("Toolbar", "نوار ابزار"),
        ("Opacity under cursor", "شفافیت زیر مکان‌نما"),
        ("Quality monitor", "مانیتور کیفیت"),
        ("Inactive opacity", "شفافیت غیرفعال"),
        ("Fade delay", "تاخیر محو شدن"),
        ("Fade duration", "مدت زمان محو شدن"),
        ("Quality monitor appearance", "ظاهر مانیتور کیفیت"),
        ("Toolbar inactive opacity", "شفافیت غیرفعال نوار ابزار"),
        ("Toolbar fade delay", "تاخیر محو شدن نوار ابزار"),
        ("Toolbar fade duration", "مدت زمان محو شدن نوار ابزار"),
        ("Default Screen Scrolling", "پیمایش پیش‌فرض صفحه"),
        ("Cursor inertia time", "زمان اینرسی مکان‌نما"),

        ("Physical key input (VM compatibility)", "ورودی کلید فیزیکی (سازگاری ماشین مجازی)"),
        ("Settings layout", "چیدمان تنظیمات"),
        ("Modern", "مدرن"),
        ("Classic", "کلاسیک"),
