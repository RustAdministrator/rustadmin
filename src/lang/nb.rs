...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Overleggsutseende"),
        ("Toolbar", "Verktøylinje"),
        ("Opacity under cursor", "Ugjennomsiktighet under peker"),
        ("Quality monitor", "Kvalitetsovervåker"),
        ("Inactive opacity", "Inaktiv ugjennomsiktighet"),
        ("Fade delay", "Toningforsinkelse"),
        ("Fade duration", "Toningvarighet"),
        ("Quality monitor appearance", "Utseende for kvalitetsovervåker"),
        ("Toolbar inactive opacity", "Inaktiv ugjennomsiktighet for verktøylinje"),
        ("Toolbar fade delay", "Toningforsinkelse for verktøylinje"),
        ("Toolbar fade duration", "Toningvarighet for verktøylinje"),
        ("Default Screen Scrolling", "Standard skjermrulling"),
        ("Cursor inertia time", "Treghetstid for peker"),

        ("Physical key input (VM compatibility)", "Fysisk tasteinntasting (VM-kompatibilitet)"),
        ("Settings layout", "Innstillingslayout"),
        ("Modern", "Moderne"),
        ("Classic", "Klassisk"),
