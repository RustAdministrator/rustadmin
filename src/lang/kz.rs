...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Қабаттасу сыртқы түрі"),
        ("Toolbar", "Құралдар тақтасы"),
        ("Opacity under cursor", "Меңзер астындағы мөлдірлік"),
        ("Quality monitor", "Сапа мониторы"),
        ("Inactive opacity", "Белсенді емес мөлдірлік"),
        ("Fade delay", "Өшу кідірісі"),
        ("Fade duration", "Өшу ұзақтығы"),
        ("Quality monitor appearance", "Сапа мониторының сыртқы түрі"),
        ("Toolbar inactive opacity", "Құралдар тақтасының белсенді емес мөлдірлігі"),
        ("Toolbar fade delay", "Құралдар тақтасының өшу кідірісі"),
        ("Toolbar fade duration", "Құралдар тақтасының өшу ұзақтығы"),
        ("Default Screen Scrolling", "Экранның әдепкі айналдыруы"),
        ("Cursor inertia time", "Меңзер инерция уақыты"),

        ("Physical key input (VM compatibility)", "Физикалық пернелерді енгізу (ВМ үйлесімділігі)"),
        ("Settings layout", "Баптаулар орналасуы"),
        ("Modern", "Заманауи"),
        ("Classic", "Классикалық"),
