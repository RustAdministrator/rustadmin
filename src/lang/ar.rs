...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "مظهر التراكب"),
        ("Toolbar", "شريط الأدوات"),
        ("Opacity under cursor", "التعتيم تحت المؤشر"),
        ("Quality monitor", "مراقب الجودة"),
        ("Inactive opacity", "تعتيم الخمول"),
        ("Fade delay", "تأخير التلاشي"),
        ("Fade duration", "مدة التلاشي"),
        ("Quality monitor appearance", "مظهر مراقب الجودة"),
        ("Toolbar inactive opacity", "تعتيم شريط الأدوات عند الخمول"),
        ("Toolbar fade delay", "تأخير تلاشي شريط الأدوات"),
        ("Toolbar fade duration", "مدة تلاشي شريط الأدوات"),
        ("Default Screen Scrolling", "تمرير الشاشة الافتراضي"),
        ("Cursor inertia time", "وقت قصور المؤشر"),

        ("Physical key input (VM compatibility)", "إدخال المفاتيح الفعلي (توافق الجهاز الظاهري)"),
        ("Settings layout", "تخطيط الإعدادات"),
        ("Modern", "حديث"),
        ("Classic", "كلاسيكي"),
        ("Diagnostics", "التشخيص"),
    ].iter().cloned().collect();
