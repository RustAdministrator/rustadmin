...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Fiziksel tuş girişi (VM uyumluluğu)"),
        ...
        ("Overlay appearance", "Arayüz görünümü"),
        ("Toolbar", "Araç çubuğu"),
        ("Opacity under cursor", "İmleç altı opaklık"),
        ("Quality monitor", "Kalite monitörü"),
        ("Inactive opacity", "Pasif opaklık"),
        ("Fade delay", "Kaybolma gecikmesi"),
        ("Fade duration", "Kaybolma süresi"),
        ("Quality monitor appearance", "Kalite monitörü görünümü"),
        ("Toolbar inactive opacity", "Araç çubuğu pasif opaklığı"),
        ("Toolbar fade delay", "Araç çubuğu kaybolma gecikmesi"),
        ("Toolbar fade duration", "Araç çubuğu kaybolma süresi"),
        ("Default Screen Scrolling", "Varsayılan Ekran Kaydırma"),
        ("Cursor inertia time", "İmleç eylemsizlik süresi"),

        ("Settings layout", "Ayarlar düzeni"),
        ("Modern", "Modern"),
        ("Classic", "Klasik"),
