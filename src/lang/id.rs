...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Tampilan overlay"),
        ("Toolbar", "Bilah alat"),
        ("Opacity under cursor", "Opasitas di bawah kursor"),
        ("Quality monitor", "Monitor kualitas"),
        ("Inactive opacity", "Opasitas nonaktif"),
        ("Fade delay", "Penundaan pudar"),
        ("Fade duration", "Durasi pudar"),
        ("Quality monitor appearance", "Tampilan monitor kualitas"),
        ("Toolbar inactive opacity", "Opasitas bilah alat nonaktif"),
        ("Toolbar fade delay", "Penundaan pudar bilah alat"),
        ("Toolbar fade duration", "Durasi pudar bilah alat"),
        ("Default Screen Scrolling", "Pengguliran Layar Default"),
        ("Cursor inertia time", "Waktu inersia kursor"),

        ("Physical key input (VM compatibility)", "Input tombol fisik (kompatibilitas VM)"),
        ("Settings layout", "Tata letak pengaturan"),
        ("Modern", "Modern"),
        ("Classic", "Klasik"),
