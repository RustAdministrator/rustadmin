...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Weergave overlay"),
        ("Toolbar", "Werkbalk"),
        ("Opacity under cursor", "Ondoorzichtigheid onder muisaanwijzer"),
        ("Quality monitor", "Kwaliteitsmonitor"),
        ("Inactive opacity", "Inactieve ondoorzichtigheid"),
        ("Fade delay", "Vertraging vervagen"),
        ("Fade duration", "Duur vervagen"),
        ("Quality monitor appearance", "Weergave kwaliteitsmonitor"),
        ("Toolbar inactive opacity", "Inactieve ondoorzichtigheid werkbalk"),
        ("Toolbar fade delay", "Vertraging vervagen werkbalk"),
        ("Toolbar fade duration", "Duur vervagen werkbalk"),
        ("Default Screen Scrolling", "Standaard scherm scrollen"),
        ("Cursor inertia time", "Traagheidstijd muisaanwijzer"),

        ("Physical key input (VM compatibility)", "Fysieke toetsinvoer (VM-compatibiliteit)"),
        ("Settings layout", "Instellingenindeling"),
        ("Modern", "Modern"),
        ("Classic", "Klassiek"),
