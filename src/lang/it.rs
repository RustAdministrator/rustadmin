...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Aspetto dell'overlay"),
        ("Toolbar", "Barra degli strumenti"),
        ("Opacity under cursor", "Opacità sotto il cursore"),
        ("Quality monitor", "Monitor di qualità"),
        ("Inactive opacity", "Opacità inattiva"),
        ("Fade delay", "Ritardo di dissolvenza"),
        ("Fade duration", "Durata della dissolvenza"),
        ("Quality monitor appearance", "Aspetto del monitor di qualità"),
        ("Toolbar inactive opacity", "Opacità inattiva della barra"),
        ("Toolbar fade delay", "Ritardo di dissolvenza della barra"),
        ("Toolbar fade duration", "Durata della dissolvenza della barra"),
        ("Default Screen Scrolling", "Scorrimento schermo predefinito"),
        ("Cursor inertia time", "Tempo di inerzia del cursore"),

        ("Physical key input (VM compatibility)", "Input da tastiera fisica (compatibilità VM)"),
        ("Settings layout", "Layout impostazioni"),
        ("Modern", "Moderno"),
        ("Classic", "Classico"),
