...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Fizični vnos tipk (združljivost z VM)"),
        ...
        ("Overlay appearance", "Videz prekrivanja"),
        ("Toolbar", "Orodna vrstica"),
        ("Opacity under cursor", "Prekrivnost pod kazalcem"),
        ("Quality monitor", "Nadzornik kakovosti"),
        ("Inactive opacity", "Neaktivna prekrivnost"),
        ("Fade delay", "Zakasnitev bledenja"),
        ("Fade duration", "Trajanje bledenja"),
        ("Quality monitor appearance", "Videz nadzornika kakovosti"),
        ("Toolbar inactive opacity", "Neaktivna prekrivnost orodne vrstice"),
        ("Toolbar fade delay", "Zakasnitev bledenja orodne vrstice"),
        ("Toolbar fade duration", "Trajanje bledenja orodne vrstice"),
        ("Default Screen Scrolling", "Privzeto drsenje zaslona"),
        ("Cursor inertia time", "Čas vztrajnosti kazalca"),

        ("Settings layout", "Izgled nastavitev"),
        ("Modern", "Sodoben"),
        ("Classic", "Klasičen"),
