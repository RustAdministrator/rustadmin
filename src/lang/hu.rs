...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Fedvény megjelenése"),
        ("Toolbar", "Eszköztár"),
        ("Opacity under cursor", "Átlátszatlanság a mutató alatt"),
        ("Quality monitor", "Minőségfigyelő"),
        ("Inactive opacity", "Inaktív átlátszatlanság"),
        ("Fade delay", "Elhalványulás késleltetése"),
        ("Fade duration", "Elhalványulás időtartama"),
        ("Quality monitor appearance", "Minőségfigyelő megjelenése"),
        ("Toolbar inactive opacity", "Eszköztár inaktív átlátszatlansága"),
        ("Toolbar fade delay", "Eszköztár elhalványulási késleltetése"),
        ("Toolbar fade duration", "Eszköztár elhalványulási időtartama"),
        ("Default Screen Scrolling", "Alapértelmezett képernyőgörgetés"),
        ("Cursor inertia time", "Mutató tehetetlenségi ideje"),

        ("Physical key input (VM compatibility)", "Fizikai billentyűzet (VM kompatibilitás)"),
        ("Settings layout", "Beállítások elrendezése"),
        ("Modern", "Modern"),
        ("Classic", "Klasszikus"),
