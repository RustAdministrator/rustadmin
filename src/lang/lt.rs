...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Perdangos išvaizda"),
        ("Toolbar", "Įrankių juosta"),
        ("Opacity under cursor", "Nepermatomumas po žymekliu"),
        ("Quality monitor", "Kokybės monitorius"),
        ("Inactive opacity", "Neaktyvus nepermatomumas"),
        ("Fade delay", "Išnykimo delsa"),
        ("Fade duration", "Išnykimo trukmė"),
        ("Quality monitor appearance", "Kokybės monitoriaus išvaizda"),
        ("Toolbar inactive opacity", "Įrankių juostos neaktyvus nepermatomumas"),
        ("Toolbar fade delay", "Įrankių juostos išnykimo delsa"),
        ("Toolbar fade duration", "Įrankių juostos išnykimo trukmė"),
        ("Default Screen Scrolling", "Numatytasis ekrano slinkimas"),
        ("Cursor inertia time", "Žymeklio inercijos laikas"),

        ("Physical key input (VM compatibility)", "Fizinių klavišų įvestis (VM suderinamumas)"),
        ("Settings layout", "Nustatymų išdėstymas"),
        ("Modern", "Modernus"),
        ("Classic", "Klasikinis"),
