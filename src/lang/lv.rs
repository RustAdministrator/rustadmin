...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Pārklājuma izskats"),
        ("Toolbar", "Rīkjosla"),
        ("Opacity under cursor", "Necaurspīdība zem kursora"),
        ("Quality monitor", "Kvalitātes monitors"),
        ("Inactive opacity", "Neaktīvā necaurspīdība"),
        ("Fade delay", "Izgaišanas aizkave"),
        ("Fade duration", "Izgaišanas ilgums"),
        ("Quality monitor appearance", "Kvalitātes monitora izskats"),
        ("Toolbar inactive opacity", "Rīkjoslas neaktīvā necaurspīdība"),
        ("Toolbar fade delay", "Rīkjoslas izgaišanas aizkave"),
        ("Toolbar fade duration", "Rīkjoslas izgaišanas ilgums"),
        ("Default Screen Scrolling", "Noklusējuma ekrāna ritināšana"),
        ("Cursor inertia time", "Kursora inerces laiks"),

        ("Physical key input (VM compatibility)", "Fizisko taustiņu ievade (VM saderība)"),
        ("Settings layout", "Iestatījumu izkārtojums"),
        ("Modern", "Moderns"),
        ("Classic", "Klasisks"),
