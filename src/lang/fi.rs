...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Peittokuvan ulkoasu"),
        ("Toolbar", "Työkalupalkki"),
        ("Opacity under cursor", "Peittävyys osoittimen alla"),
        ("Quality monitor", "Laadunvalvonta"),
        ("Inactive opacity", "Peittävyys passiivisena"),
        ("Fade delay", "Häivytyksen viive"),
        ("Fade duration", "Häivytyksen kesto"),
        ("Quality monitor appearance", "Laadunvalvonnan ulkoasu"),
        ("Toolbar inactive opacity", "Työkalupalkin peittävyys passiivisena"),
        ("Toolbar fade delay", "Työkalupalkin häivytyksen viive"),
        ("Toolbar fade duration", "Työkalupalkin häivytyksen kesto"),
        ("Default Screen Scrolling", "Näytön oletusvieritys"),
        ("Cursor inertia time", "Osoittimen inertia-aika"),

        ("Physical key input (VM compatibility)", "Fyysinen näppäinsyöttö (VM-yhteensopivuus)"),
        ("Settings layout", "Asetusten asettelu"),
        ("Modern", "Moderni"),
        ("Classic", "Klassinen"),
