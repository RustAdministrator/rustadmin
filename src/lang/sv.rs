...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Fysisk tangentinmatning (VM-kompatibilitet)"),
        ...
        ("Overlay appearance", "Överläggsutseende"),
        ("Toolbar", "Verktygsfält"),
        ("Opacity under cursor", "Opacitet under muspekaren"),
        ("Quality monitor", "Kvalitetsövervakare"),
        ("Inactive opacity", "Inaktiv opacitet"),
        ("Fade delay", "Fördröjning av uttoning"),
        ("Fade duration", "Uttoningstid"),
        ("Quality monitor appearance", "Utseende för kvalitetsövervakare"),
        ("Toolbar inactive opacity", "Verktygsfält inaktiv opacitet"),
        ("Toolbar fade delay", "Fördröjning av uttoning för verktygsfält"),
        ("Toolbar fade duration", "Uttoningstid för verktygsfält"),
        ("Default Screen Scrolling", "Standard skärmrullning"),
        ("Cursor inertia time", "Muspekarens tröghetstid"),

        ("Settings layout", "Inställningslayout"),
        ("Modern", "Modern"),
        ("Classic", "Klassisk"),
