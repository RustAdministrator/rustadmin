...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Gainjartzearen itxura"),
        ("Toolbar", "Tresna-barra"),
        ("Opacity under cursor", "Opakutasuna kurtsorearen azpian"),
        ("Quality monitor", "Kalitate-monitorea"),
        ("Inactive opacity", "Opakutasun inaktiboa"),
        ("Fade delay", "Desagertze-atzerapena"),
        ("Fade duration", "Desagertze-iraupena"),
        ("Quality monitor appearance", "Kalitate-monitorearen itxura"),
        ("Toolbar inactive opacity", "Tresna-barraren opakutasun inaktiboa"),
        ("Toolbar fade delay", "Tresna-barraren desagertze-atzerapena"),
        ("Toolbar fade duration", "Tresna-barraren desagertze-iraupena"),
        ("Default Screen Scrolling", "Pantailaren korritze lehenetsia"),
        ("Cursor inertia time", "Kurtsorearen inertzia-denbora"),

        ("Physical key input (VM compatibility)", "Teklatu fisikoaren sarrera (VM bateragarritasuna)"),
        ("Settings layout", "Ezarpenen diseinua"),
        ("Modern", "Modernoa"),
        ("Classic", "Klasikoa"),
