...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Overlay-Erscheinungsbild"),
        ("Toolbar", "Symbolleiste"),
        ("Opacity under cursor", "Deckkraft unter dem Cursor"),
        ("Quality monitor", "Qualitätsmonitor"),
        ("Inactive opacity", "Inaktive Deckkraft"),
        ("Fade delay", "Ausblendverzögerung"),
        ("Fade duration", "Ausblenddauer"),
        ("Quality monitor appearance", "Erscheinungsbild des Qualitätsmonitors"),
        ("Toolbar inactive opacity", "Inaktive Deckkraft der Symbolleiste"),
        ("Toolbar fade delay", "Ausblendverzögerung der Symbolleiste"),
        ("Toolbar fade duration", "Ausblenddauer der Symbolleiste"),
        ("Default Screen Scrolling", "Standard-Bildschirmbildlauf"),
        ("Cursor inertia time", "Cursor-Trägheitszeit"),

        ("Physical key input (VM compatibility)", "Physische Tasteneingabe (VM-Kompatibilität)"),
        ("Settings layout", "Einstellungs-Layout"),
        ("Modern", "Modern"),
        ("Classic", "Klassisch"),
