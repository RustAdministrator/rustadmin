...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Wygląd nakładki"),
        ("Toolbar", "Pasek narzędzi"),
        ("Opacity under cursor", "Krycie pod kursorem"),
        ("Quality monitor", "Monitor jakości"),
        ("Inactive opacity", "Krycie w stanie nieaktywnym"),
        ("Fade delay", "Opóźnienie zanikania"),
        ("Fade duration", "Czas zanikania"),
        ("Quality monitor appearance", "Wygląd monitora jakości"),
        ("Toolbar inactive opacity", "Nieaktywne krycie paska narzędzi"),
        ("Toolbar fade delay", "Opóźnienie zanikania paska narzędzi"),
        ("Toolbar fade duration", "Czas zanikania paska narzędzi"),
        ("Default Screen Scrolling", "Domyślne przewijanie ekranu"),
        ("Cursor inertia time", "Czas bezwładności kursora"),

        ("Physical key input (VM compatibility)", "Fizyczne wprowadzanie klawiszy (zgodność z VM)"),
        ("Settings layout", "Układ ustawień"),
        ("Modern", "Nowoczesny"),
        ("Classic", "Klasyczny"),
