...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Выгляд накладання"),
        ("Toolbar", "Панэль інструментаў"),
        ("Opacity under cursor", "Непразрыстасць пад курсорам"),
        ("Quality monitor", "Манітор якасці"),
        ("Inactive opacity", "Непразрыстасць у бяздзейнасці"),
        ("Fade delay", "Затрымка згасання"),
        ("Fade duration", "Працягласць згасання"),
        ("Quality monitor appearance", "Выгляд манітора якасці"),
        ("Toolbar inactive opacity", "Непразрыстасць панэлі інструментаў у бяздзейнасці"),
        ("Toolbar fade delay", "Затрымка згасання панэлі інструментаў"),
        ("Toolbar fade duration", "Працягласць згасання панэлі інструментаў"),
        ("Default Screen Scrolling", "Стандартная пракрутка экрана"),
        ("Cursor inertia time", "Час інерцыі курсора"),

        ("Physical key input (VM compatibility)", "Фізічны ўвод клавіш (сумяшчальнасць з ВМ)"),
        ("Settings layout", "Макет налад"),
        ("Modern", "Сучасны"),
        ("Classic", "Класічны"),
