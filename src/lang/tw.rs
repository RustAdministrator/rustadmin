...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "實體按鍵輸入 (VM 相容性)"),
        ("Full Access", "完全存取"),
        ...
        ("Overlay appearance", "覆蓋層外觀"),
        ("Toolbar", "工具列"),
        ("Opacity under cursor", "游標懸停時的不透明度"),
        ("Quality monitor", "品質監視器"),
        ("Inactive opacity", "非活動時的不透明度"),
        ("Fade delay", "淡出延遲"),
        ("Fade duration", "淡出持續時間"),
        ("Quality monitor appearance", "品質監視器外觀"),
        ("Toolbar inactive opacity", "工具列非活動不透明度"),
        ("Toolbar fade delay", "工具列淡出延遲"),
        ("Toolbar fade duration", "工具列淡出持續時間"),
        ("Default Screen Scrolling", "預設螢幕捲動"),
        ("Cursor inertia time", "游標慣性時間"),

        ("Settings layout", "設定佈局"),
        ("Modern", "現代"),
        ("Classic", "經典"),
        ("Diagnostics", "診斷"),
    ].iter().cloned().collect();
