...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Aspect suprapunere"),
        ("Toolbar", "Bara de instrumente"),
        ("Opacity under cursor", "Opacitate sub cursor"),
        ("Quality monitor", "Monitor de calitate"),
        ("Inactive opacity", "Opacitate inactivă"),
        ("Fade delay", "Întârziere estompare"),
        ("Fade duration", "Durată estompare"),
        ("Quality monitor appearance", "Aspect monitor de calitate"),
        ("Toolbar inactive opacity", "Opacitate inactivă bară de instrumente"),
        ("Toolbar fade delay", "Întârziere estompare bară de instrumente"),
        ("Toolbar fade duration", "Durată estompare bară de instrumente"),
        ("Default Screen Scrolling", "Derulare implicită a ecranului"),
        ("Cursor inertia time", "Timp inerție cursor"),

        ("Physical key input (VM compatibility)", "Introducere cu taste fizice (compatibilitate VM)"),
        ("Settings layout", "Aspect setări"),
        ("Modern", "Modern"),
        ("Classic", "Clasic"),
