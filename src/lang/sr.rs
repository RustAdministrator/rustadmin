...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Fizički unos tastera (VM kompatibilnost)"),
        ...
        ("Overlay appearance", "Izgled preklapanja"),
        ("Toolbar", "Traka sa alatkama"),
        ("Opacity under cursor", "Neprozirnost ispod kursora"),
        ("Quality monitor", "Monitor kvaliteta"),
        ("Inactive opacity", "Neprozirnost neaktivnog"),
        ("Fade delay", "Odlaganje iščezavanja"),
        ("Fade duration", "Trajanje iščezavanja"),
        ("Quality monitor appearance", "Izgled monitora kvaliteta"),
        ("Toolbar inactive opacity", "Neprozirnost neaktivne trake sa alatkama"),
        ("Toolbar fade delay", "Odlaganje iščezavanja trake sa alatkama"),
        ("Toolbar fade duration", "Trajanje iščezavanja trake sa alatkama"),
        ("Default Screen Scrolling", "Podrazumevano pomeranje ekrana"),
        ("Cursor inertia time", "Vreme inercije kursora"),

        ("Settings layout", "Изглед подешавања"),
        ("Modern", "Модеран"),
        ("Classic", "Класичан"),
