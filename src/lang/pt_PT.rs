...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Aparência da sobreposição"),
        ("Toolbar", "Barra de ferramentas"),
        ("Opacity under cursor", "Opacidade sob o cursor"),
        ("Quality monitor", "Monitor de qualidade"),
        ("Inactive opacity", "Opacidade inativa"),
        ("Fade delay", "Atraso de desvanecimento"),
        ("Fade duration", "Duração do desvanecimento"),
        ("Quality monitor appearance", "Aparência do monitor de qualidade"),
        ("Toolbar inactive opacity", "Opacidade inativa da barra"),
        ("Toolbar fade delay", "Atraso de desvanecimento da barra"),
        ("Toolbar fade duration", "Duração do desvanecimento da barra"),
        ("Default Screen Scrolling", "Deslocamento de ecrã padrão"),
        ("Cursor inertia time", "Tempo de inércia do cursor"),

        ("Physical key input (VM compatibility)", "Entrada de teclas físicas (compatibilidade com VM)"),
        ("Settings layout", "Disposição das definições"),
        ("Modern", "Moderno"),
        ("Classic", "Clássico"),
