...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Fade delay", "Atraso de desaparecimento"),
        ("Fade duration", "Duração do desaparecimento"),
        ("Quality monitor appearance", "Aparência do monitor de qualidade"),
        ("Toolbar inactive opacity", "Opacidade inativa da barra"),
        ("Toolbar fade delay", "Atraso de desaparecimento da barra"),
        ("Toolbar fade duration", "Duração do desaparecimento da barra"),
        ("Default Screen Scrolling", "Rolagem de tela padrão"),
        ...
        ("Settings layout", "Layout das configurações"),
        ("Modern", "Moderno"),
        ("Classic", "Clássico"),
