...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Fyzický vstup kláves (kompatibilita s VM)"),
        ...
        ("Overlay appearance", "Vzhľad prekrytia"),
        ("Toolbar", "Panel nástrojov"),
        ("Opacity under cursor", "Nepriehľadnosť pod kurzorom"),
        ("Quality monitor", "Monitor kvality"),
        ("Inactive opacity", "Neaktívna nepriehľadnosť"),
        ("Fade delay", "Oneskorenie zmiznutia"),
        ("Fade duration", "Trvanie zmiznutia"),
        ("Quality monitor appearance", "Vzhľad monitora kvality"),
        ("Toolbar inactive opacity", "Neaktívna nepriehľadnosť panela nástrojov"),
        ("Toolbar fade delay", "Oneskorenie zmiznutia panela nástrojov"),
        ("Toolbar fade duration", "Trvanie zmiznutia panela nástrojov"),
        ("Default Screen Scrolling", "Predvolené posúvanie obrazovky"),
        ("Cursor inertia time", "Čas zotrvačnosti kurzora"),

        ("Settings layout", "Rozloženie nastavení"),
        ("Modern", "Moderné"),
        ("Classic", "Klasické"),
