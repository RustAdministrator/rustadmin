...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "இயற்பியல் விசை உள்ளீடு (VM பொருந்தக்கூடிய தன்மை)"),
        ...
        ("Overlay appearance", "மேலடுக்கு தோற்றம்"),
        ("Toolbar", "கருவிப்பட்டை"),
        ("Opacity under cursor", "கர்சரின் கீழ் ஒளிபுகா தன்மை"),
        ("Quality monitor", "தரக் கண்காணிப்பு"),
        ("Inactive opacity", "செயலற்ற ஒளிபுகா தன்மை"),
        ("Fade delay", "மறைதல் தாமதம்"),
        ("Fade duration", "மறைதல் காலம்"),
        ("Quality monitor appearance", "தரக் கண்காணிப்பு தோற்றம்"),
        ("Toolbar inactive opacity", "கருவிப்பட்டை செயலற்ற ஒளிபுகா தன்மை"),
        ("Toolbar fade delay", "கருவிப்பட்டை மறைதல் தாமதம்"),
        ("Toolbar fade duration", "கருவிப்பட்டை மறைதல் காலம்"),
        ("Default Screen Scrolling", "இயல்புநிலை திரை உருட்டல்"),
        ("Cursor inertia time", "கர்சர் நிலைம நேரம்"),

        ("Settings layout", "அமைப்புகள் அமைவு"),
        ("Modern", "நவீன"),
        ("Classic", "கிளாசிக்"),
