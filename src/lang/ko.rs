...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "오버레이 모양"),
        ("Toolbar", "도구 모음"),
        ("Opacity under cursor", "커서 아래 불투명도"),
        ("Quality monitor", "품질 모니터"),
        ("Inactive opacity", "비활성 불투명도"),
        ("Fade delay", "페이드 지연"),
        ("Fade duration", "페이드 지속 시간"),
        ("Quality monitor appearance", "품질 모니터 모양"),
        ("Toolbar inactive opacity", "도구 모음 비활성 불투명도"),
        ("Toolbar fade delay", "도구 모음 페이드 지연"),
        ("Toolbar fade duration", "도구 모음 페이드 지속 시간"),
        ("Default Screen Scrolling", "기본 화면 스크롤"),
        ("Cursor inertia time", "커서 관성 시간"),

        ("Physical key input (VM compatibility)", "물리적 키 입력 (VM 호환성)"),
        ("Settings layout", "설정 레이아웃"),
        ("Modern", "모던"),
        ("Classic", "클래식"),
        ("Diagnostics", "진단"),
    ].iter().cloned().collect();
