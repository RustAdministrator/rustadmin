...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Фізичне введення клавіш (сумісність із VM)"),
        ...
        ("Overlay appearance", "Вигляд накладення"),
        ("Toolbar", "Панель інструментів"),
        ("Opacity under cursor", "Непрозорість під курсором"),
        ("Quality monitor", "Монітор якості"),
        ("Inactive opacity", "Непрозорість неактивного"),
        ("Fade delay", "Затримка згасання"),
        ("Fade duration", "Тривалість згасання"),
        ("Quality monitor appearance", "Вигляд монітора якості"),
        ("Toolbar inactive opacity", "Непрозорість неактивної панелі інструментів"),
        ("Toolbar fade delay", "Затримка згасання панелі інструментів"),
        ("Toolbar fade duration", "Тривалість згасання панелі інструментів"),
        ("Default Screen Scrolling", "Прокручування екрана за замовчуванням"),
        ("Cursor inertia time", "Час інерції курсора"),

        ("Settings layout", "Макет налаштувань"),
        ("Modern", "Сучасний"),
        ("Classic", "Класичний"),
