...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Aspekto de surmetaĵo"),
        ("Toolbar", "Ilobreto"),
        ("Opacity under cursor", "Opakeco sub muskursoro"),
        ("Quality monitor", "Kvalita monitoro"),
        ("Inactive opacity", "Neaktiva opakeco"),
        ("Fade delay", "Malaper-prokrasto"),
        ("Fade duration", "Malaper-daŭro"),
        ("Quality monitor appearance", "Aspekto de kvalita monitoro"),
        ("Toolbar inactive opacity", "Neaktiva opakeco de ilobreto"),
        ("Toolbar fade delay", "Malaper-prokrasto de ilobreto"),
        ("Toolbar fade duration", "Malaper-daŭro de ilobreto"),
        ("Default Screen Scrolling", "Defaŭlta ekrana rulumado"),
        ("Cursor inertia time", "Inercia tempo de muskursoro"),

        ("Physical key input (VM compatibility)", "Fizika klavenigo (VM-kongrueco)"),
        ("Settings layout", "Aranĝo de agordoj"),
        ("Modern", "Moderna"),
        ("Classic", "Klasika"),
