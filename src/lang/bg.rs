...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Изглед на наслагването"),
        ("Toolbar", "Лента с инструменти"),
        ("Opacity under cursor", "Непрозрачност под курсора"),
        ("Quality monitor", "Монитор на качеството"),
        ("Inactive opacity", "Непрозрачност при неактивност"),
        ("Fade delay", "Закъснение на избледняването"),
        ("Fade duration", "Продължителност на избледняването"),
        ("Quality monitor appearance", "Изглед на монитора на качеството"),
        ("Toolbar inactive opacity", "Непрозрачност на лентата при неактивност"),
        ("Toolbar fade delay", "Закъснение на избледняването на лентата"),
        ("Toolbar fade duration", "Продължителност на избледняването на лентата"),
        ("Default Screen Scrolling", "Стандартно превъртане на екрана"),
        ("Cursor inertia time", "Време на инерция на курсора"),

        ("Physical key input (VM compatibility)", "Физическо въвеждане на клавиши (съвместимост с ВМ)"),
        ("Settings layout", "Оформление на настройките"),
        ("Modern", "Модерен"),
        ("Classic", "Класически"),
