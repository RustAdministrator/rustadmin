...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "מראה שכבת-על"),
        ("Toolbar", "סרגל כלים"),
        ("Opacity under cursor", "שקיפות תחת הסמן"),
        ("Quality monitor", "צג איכות"),
        ("Inactive opacity", "שקיפות במצב לא פעיל"),
        ("Fade delay", "השהיית עמעום"),
        ("Fade duration", "משך עמעום"),
        ("Quality monitor appearance", "מראה צג איכות"),
        ("Toolbar inactive opacity", "שקיפות סרגל כלים במצב לא פעיל"),
        ("Toolbar fade delay", "השהיית עמעום של סרגל הכלים"),
        ("Toolbar fade duration", "משך עמעום של סרגל הכלים"),
        ("Default Screen Scrolling", "גלילת מסך ברירת מחדל"),
        ("Cursor inertia time", "זמן התמדת סמן"),

        ("Physical key input (VM compatibility)", "קלט מקשים פיזי (תאימות VM)"),
        ("Settings layout", "פריסת הגדרות"),
        ("Modern", "מודרני"),
        ("Classic", "קלאסי"),
        ("Diagnostics", "אבחון"),
    ].iter().cloned().collect();
