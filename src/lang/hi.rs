...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "ओवरले दिखावट"),
        ("Toolbar", "टूलबार"),
        ("Opacity under cursor", "कर्सर के नीचे अस्पष्टता"),
        ("Quality monitor", "गुणवत्ता मॉनिटर"),
        ("Inactive opacity", "निष्क्रिय अस्पष्टता"),
        ("Fade delay", "फेड देरी"),
        ("Fade duration", "फेड अवधि"),
        ("Quality monitor appearance", "गुणवत्ता मॉनिटर दिखावट"),
        ("Toolbar inactive opacity", "टूलबार निष्क्रिय अस्पष्टता"),
        ("Toolbar fade delay", "टूलबार फेड देरी"),
        ("Toolbar fade duration", "टूलबार फेड अवधि"),
        ("Default Screen Scrolling", "डिफ़ॉल्ट स्क्रीन स्क्रॉलिंग"),
        ("Cursor inertia time", "कर्सर जड़ता समय"),

        ("Physical key input (VM compatibility)", "भौतिक कुंजी इनपुट (VM संगतता)"),
        ("Settings layout", "सेटिंग्स लेआउट"),
        ("Modern", "आधुनिक"),
        ("Classic", "क्लासिक"),
        ("Diagnostics", "निदान"),
    ].iter().cloned().collect();
