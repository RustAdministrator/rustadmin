...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Nhập phím vật lý (Khả năng tương thích VM)"),
        ...
        ("Overlay appearance", "Giao diện lớp phủ"),
        ("Toolbar", "Thanh công cụ"),
        ("Opacity under cursor", "Độ mờ dưới con trỏ"),
        ("Quality monitor", "Trình giám sát chất lượng"),
        ("Inactive opacity", "Độ mờ khi không hoạt động"),
        ("Fade delay", "Độ trễ mờ dần"),
        ("Fade duration", "Thời gian mờ dần"),
        ("Quality monitor appearance", "Giao diện trình giám sát chất lượng"),
        ("Toolbar inactive opacity", "Độ mờ thanh công cụ khi không hoạt động"),
        ("Toolbar fade delay", "Độ trễ mờ dần của thanh công cụ"),
        ("Toolbar fade duration", "Thời gian mờ dần của thanh công cụ"),
        ("Default Screen Scrolling", "Cuộn màn hình mặc định"),
        ("Cursor inertia time", "Thời gian quán tính của con trỏ"),

        ("Settings layout", "Bố cục cài đặt"),
        ("Modern", "Hiện đại"),
        ("Classic", "Cổ điển"),
