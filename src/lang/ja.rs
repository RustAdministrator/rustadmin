...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "オーバーレイの外観"),
        ("Toolbar", "ツールバー"),
        ("Opacity under cursor", "カーソル下の不透明度"),
        ("Quality monitor", "品質モニター"),
        ("Inactive opacity", "非アクティブ時の不透明度"),
        ("Fade delay", "フェード遅延"),
        ("Fade duration", "フェード時間"),
        ("Quality monitor appearance", "品質モニターの外観"),
        ("Toolbar inactive opacity", "ツールバーの非アクティブ時の不透明度"),
        ("Toolbar fade delay", "ツールバーのフェード遅延"),
        ("Toolbar fade duration", "ツールバーのフェード時間"),
        ("Default Screen Scrolling", "デフォルトの画面スクロール"),
        ("Cursor inertia time", "カーソルの慣性時間"),

        ("Physical key input (VM compatibility)", "物理キー入力 (VM 互換性)"),
        ("Settings layout", "設定のレイアウト"),
        ("Modern", "モダン"),
        ("Classic", "クラシック"),
        ("Diagnostics", "診断"),
    ].iter().cloned().collect();
