...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "การป้อนคีย์จริง (ความเข้ากันได้กับ VM)"),
        ...
        ("Overlay appearance", "ลักษณะหน้าต่างซ้อนทับ"),
        ("Toolbar", "แถบเครื่องมือ"),
        ("Opacity under cursor", "ความทึบแสงเมื่อเคอร์เซอร์อยู่เหนือ"),
        ("Quality monitor", "ตัวตรวจสอบคุณภาพ"),
        ("Inactive opacity", "ความทึบแสงเมื่อไม่ใช้งาน"),
        ("Fade delay", "ความหน่วงการจาง"),
        ("Fade duration", "ระยะเวลาการจาง"),
        ("Quality monitor appearance", "ลักษณะตัวตรวจสอบคุณภาพ"),
        ("Toolbar inactive opacity", "ความทึบแสงของแถบเครื่องมือเมื่อไม่ใช้งาน"),
        ("Toolbar fade delay", "ความหน่วงการจางของแถบเครื่องมือ"),
        ("Toolbar fade duration", "ระยะเวลาการจางของแถบเครื่องมือ"),
        ("Default Screen Scrolling", "การเลื่อนหน้าจอเริ่มต้น"),
        ("Cursor inertia time", "ระยะเวลาความเฉื่อยของเคอร์เซอร์"),

        ("Settings layout", "เลย์เอาต์การตั้งค่า"),
        ("Modern", "โมเดิร์น"),
        ("Classic", "คลาสสิก"),
