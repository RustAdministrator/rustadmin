...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Aparença de superposició"),
        ("Toolbar", "Barra d'eines"),
        ("Opacity under cursor", "Opacitat sota el cursor"),
        ("Quality monitor", "Monitor de qualitat"),
        ("Inactive opacity", "Opacitat inactiva"),
        ("Fade delay", "Retard d'esvaïment"),
        ("Fade duration", "Durada d'esvaïment"),
        ("Quality monitor appearance", "Aparença del monitor de qualitat"),
        ("Toolbar inactive opacity", "Opacitat inactiva de la barra d'eines"),
        ("Toolbar fade delay", "Retard d'esvaïment de la barra d'eines"),
        ("Toolbar fade duration", "Durada d'esvaïment de la barra d'eines"),
        ("Default Screen Scrolling", "Desplaçament de pantalla per defecte"),
        ("Cursor inertia time", "Temps d'inèrcia del cursor"),

        ("Physical key input (VM compatibility)", "Entrada de tecles física (compatibilitat amb VM)"),
        ("Settings layout", "Disseny de la configuració"),
        ("Modern", "Modern"),
        ("Classic", "Clàssic"),
