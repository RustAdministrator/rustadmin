...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Apparence de la superposition"),
        ("Toolbar", "Barre d'outils"),
        ("Opacity under cursor", "Opacité sous le curseur"),
        ("Quality monitor", "Moniteur de qualité"),
        ("Inactive opacity", "Opacité inactive"),
        ("Fade delay", "Délai de fondu"),
        ("Fade duration", "Durée de fondu"),
        ("Quality monitor appearance", "Apparence du moniteur de qualité"),
        ("Toolbar inactive opacity", "Opacité inactive de la barre d'outils"),
        ("Toolbar fade delay", "Délai de fondu de la barre d'outils"),
        ("Toolbar fade duration", "Durée de fondu de la barre d'outils"),
        ("Default Screen Scrolling", "Défilement d'écran par défaut"),
        ("Cursor inertia time", "Temps d'inertie du curseur"),

        ("Physical key input (VM compatibility)", "Saisie de touches physiques (compatibilité VM)"),
        ("Settings layout", "Disposition des paramètres"),
        ("Modern", "Moderne"),
        ("Classic", "Classique"),
