...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Hyrja e tastit fizik (pajtueshmëria me VM)"),
        ...
        ("Overlay appearance", "Pamja e mbivendosjes"),
        ("Toolbar", "Shiriti i mjeteve"),
        ("Opacity under cursor", "Patejdukshmëria nën kursor"),
        ("Quality monitor", "Monitoruesi i cilësisë"),
        ("Inactive opacity", "Patejdukshmëria joaktive"),
        ("Fade delay", "Vonesa e zbehjes"),
        ("Fade duration", "Kohëzgjatja e zbehjes"),
        ("Quality monitor appearance", "Pamja e monitoruesit të cilësisë"),
        ("Toolbar inactive opacity", "Patejdukshmëria joaktive e shiritit të mjeteve"),
        ("Toolbar fade delay", "Vonesa e zbehjes së shiritit të mjeteve"),
        ("Toolbar fade duration", "Kohëzgjatja e zbehjes së shiritit të mjeteve"),
        ("Default Screen Scrolling", "Lëvizja e paracaktuar e ekranit"),
        ("Cursor inertia time", "Koha e inercisë së kursorit"),

        ("Settings layout", "Struktura e cilësimeve"),
        ("Modern", "Moderne"),
        ("Classic", "Klasike"),
