...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "Apariencia de la superposición"),
        ("Toolbar", "Barra de herramientas"),
        ("Opacity under cursor", "Opacidad bajo el cursor"),
        ("Quality monitor", "Monitor de calidad"),
        ("Inactive opacity", "Opacidad inactiva"),
        ("Fade delay", "Retraso de desvanecimiento"),
        ("Fade duration", "Duración de desvanecimiento"),
        ("Quality monitor appearance", "Apariencia del monitor de calidad"),
        ("Toolbar inactive opacity", "Opacidad inactiva de la barra"),
        ("Toolbar fade delay", "Retraso de desvanecimiento de la barra"),
        ("Toolbar fade duration", "Duración de desvanecimiento de la barra"),
        ("Default Screen Scrolling", "Desplazamiento de pantalla predeterminado"),
        ("Cursor inertia time", "Tiempo de inercia del cursor"),

        ("Physical key input (VM compatibility)", "Entrada de teclado física (compatibilidad con VM)"),
        ("Settings layout", "Diseño de ajustes"),
        ("Modern", "Moderno"),
        ("Classic", "Clásico"),
