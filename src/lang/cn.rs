...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "覆盖层外观"),
        ("Toolbar", "工具栏"),
        ("Opacity under cursor", "鼠标悬停时的不透明度"),
        ("Quality monitor", "质量监视器"),
        ("Inactive opacity", "非活动时的不透明度"),
        ("Fade delay", "淡出延迟"),
        ("Fade duration", "淡出持续时间"),
        ("Quality monitor appearance", "质量监视器外观"),
        ("Toolbar inactive opacity", "工具栏非活动不透明度"),
        ("Toolbar fade delay", "工具栏淡出延迟"),
        ("Toolbar fade duration", "工具栏淡出持续时间"),
        ("Default Screen Scrolling", "默认屏幕滚动"),
        ("Cursor inertia time", "光标惯性时间"),

        ("Physical key input (VM compatibility)", "物理按键输入 (虚拟机兼容性)"),
