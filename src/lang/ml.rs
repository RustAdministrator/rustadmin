...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Overlay appearance", "ഓവർലേ രൂപം"),
        ("Toolbar", "ടൂൾബാർ"),
        ("Opacity under cursor", "കഴ്‌സറിന് താഴെയുള്ള ഒപ്പാസിറ്റി"),
        ("Quality monitor", "ക്വാളിറ്റി മോണിറ്റർ"),
        ("Inactive opacity", "നിഷ്ക്രിയ ഒപ്പാസിറ്റി"),
        ("Fade delay", "ഫേഡ് കാലതാമസം"),
        ("Fade duration", "ഫേഡ് ദൈർഘ്യം"),
        ("Quality monitor appearance", "ക്വാളിറ്റി മോണിറ്റർ രൂപം"),
        ("Toolbar inactive opacity", "ടൂൾബാർ നിഷ്ക്രിയ ഒപ്പാസിറ്റി"),
        ("Toolbar fade delay", "ടൂൾബാർ ഫേഡ് കാലതാമസം"),
        ("Toolbar fade duration", "ടൂൾബാർ ഫേഡ് ദൈർഘ്യം"),
        ("Default Screen Scrolling", "ഡിഫോൾട്ട് സ്ക്രീൻ സ്ക്രോളിംഗ്"),
        ("Cursor inertia time", "കഴ്‌സർ ഇനർഷ്യ സമയം"),

        ("Physical key input (VM compatibility)", "ഫിസിക്കൽ കീ ഇൻപുട്ട് (VM അനുയോജ്യത)"),
        ("Settings layout", "ക്രമീകരണ ലേഔട്ട്"),
        ("Modern", "മോഡേൺ"),
        ("Classic", "ക്ലാസിക്"),
