...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Physical key input (VM compatibility)", "Intrada de teclas fìsica (cumpatibilidade VM)"),
        ...
        ("Overlay appearance", "Aspertu de s'incrastu"),
        ("Toolbar", "Barra de is ainas"),
        ("Opacity under cursor", "Opacidade asuta de su cursore"),
        ("Quality monitor", "Monitor de calidade"),
        ("Inactive opacity", "Opacidade inativa"),
        ("Fade delay", "Ritardu de isvanimentu"),
        ("Fade duration", "Durada de isvanimentu"),
        ("Quality monitor appearance", "Aspertu de su monitor de calidade"),
        ("Toolbar inactive opacity", "Opacidade inativa de sa barra de is ainas"),
        ("Toolbar fade delay", "Ritardu de isvanimentu de sa barra de is ainas"),
        ("Toolbar fade duration", "Durada de isvanimentu de sa barra de is ainas"),
        ("Default Screen Scrolling", "Iscorridura predefinida de s'ischermu"),
        ("Cursor inertia time", "Tempore de inèrtzia de su cursore"),

        ("Settings layout", "Dispositzione de sas impostatziones"),
        ("Modern", "Modernu"),
        ("Classic", "Clàssicu"),
