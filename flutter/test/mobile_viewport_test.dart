...
void main() {
  test('fresh mobile view fits a wide remote screen to portrait height', () {
    ...
    expect(texture.width * scale, greaterThan(viewport.width));
    expect(texture.height * scale, closeTo(viewport.height, 0.000001));
  });
