...
class PlatformFFI {
  ...
  Rustadmin get ffiBind => _ffiBind;
  ...
  @visibleForTesting
  void initForTest(Rustadmin ffiBind, {String appType = kAppTypeMain}) {
    assert(isTest);
    _appType = appType;
    _ffiBind = ffiBind;
  }
  ...
  void _startListenEvent(Rustadmin rustdeskImpl) {
    final appType =
